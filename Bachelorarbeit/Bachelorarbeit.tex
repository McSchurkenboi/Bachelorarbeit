...
\subsection{Einordnung in den Entwicklungsprozess}
...
\subsection{Ablauf des RE-Prozesses}
...
\subsection{use-case / problematik im geteilten entwicklungsprozess, schaubilder 2 oem-hella, schlechte absprache} 
...
Wie bereits in Kap. 3.1 beschrieben, resultieren die Probleme auf Seiten des Zulieferers beim Verständnis der Anforderungen aus dem Umstand, dass dort ein Pflichtenheft in natürlicher Sprache vorliegt. Dieses verursacht einerseits einen Arbeitsaufwand durch die Probleme beim Umgang mit natürlicher Sprache wie z.B. sprachlichen Mehrdeutigkeiten (Kap. 2.1). Andererseits können enthaltenen Anforderungen teilweise nicht korrekt bzw. von niedriger Qualität sein, was zu inhaltlichen Probleme für die Produktentwicklung führt. 
...
Daher werden im folgenden die Ansätze aus \cite{zh17} beschrieben,  Transformation von bereits spezifizierten Anforderungen in bestehenden Pflichtenheften in eine besser verständliche und eindeutige formale Sprache hilft. Diese Ansätze haben zur konkreten Entwicklung von zwei Werkzeugen geführt, dem \textit{Requirements-To-Boilerplate-Converter} und dem \textit{Delta-Analyser}.
