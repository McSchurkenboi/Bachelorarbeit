...
Um ein Verständnis von JAPE Transducern aufzubauen ist jedoch zunächst einer Erläuterung von JAPE und JAPE-Dateien nötig, welche im Folgenden gegeben ist.   
...
\item Rule:
\end{enumerate}
In der JAPE-Regel befindet sich auf der LHS eine Menge von Regulären ausdrücken, welche 
